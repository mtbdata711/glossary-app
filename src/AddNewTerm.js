        ...
        <div className="container justify-content-center">
          ...
          <form onSubmit={this.handleSubmit} id='addNew'>
            <div className="add-new-wrapper">
              <SingleInput label='Term' placeholder='Term' type='text' name="term" controlFunc={this.handleSingle} />
              <SingleTextArea name='definition' label='Definition' controlFunc={this.handleSingle} />
              <SingleInput label='Code Example URL' placeholder='Code Example URL' type='url' name="code_example" controlFunc={this.handleSingle} />
              <SingleInput label='Topic' placeholder='Topic' type='text' name="topic" controlFunc={this.handleSingle} />
              <AddNewResource controlFunc={this.handleMultiple} name='resources' />
              <AddNewRelated controlFunc={this.handleMultiple} name='related' />
              <button type="submit" form="addNew" value='Submit' className="submit-new">Submit</button>
            </div>
          </form>
          {(this.state.generatedLink === null) ? null : <GeneratedLink topic={this.state.generatedLink[0]} term={this.state.generatedLink[1]} />}
        </div>
